...
public class ListViewTest extends Application {
	...
	public void start(Stage primaryStage) {
		...
		ObservableList<String> data = FXCollections.observableArrayList("green", "gold", "red", "blue", "black", "brown", "pink", "chocolate", "lightblue");
...
//		list = new ListView<String>(data);	//방법2
		...
		//ListView의 내용은 변경하지않고 화면에 보이는 부분을 변경해서 보여주는 방법
