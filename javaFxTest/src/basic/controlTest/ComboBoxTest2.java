...
public class ComboBoxTest2 extends Application {
	...
	public void start(Stage primaryStage) {
		...
		ObservableList<MyFriend> list = FXCollections.observableArrayList(
				...
				new MyFriend("ccc", "변학도", "010-3333-3333", "울산"),
				new MyFriend("ddd", "일지매", "010-4444-4444", "광주"),
				new MyFriend("eee", "성춘향", "010-5555-5555", "부산"),
				new MyFriend("fff", "이몽룡", "010-6666-6666", "포항")				
		);
		
		combo.setItems(list); 	//방법3
		
		//콤보박스의 데이터의 목록이 보여지는 곳의 내용을 다르게 나타내는 방법
		...
		//콤보박스에서 항목을 선택하면 선택된 내용이 콤보박스의 버튼영역에 나타나는데 이 부분도 같이 변경해 주어야한다.
...
//			selData = combo.getValue();
		...
		primaryStage.setTitle("ComboBox2 연습");
		primaryStage.show();
